...
export function ReorderableList<T>(props: ReorderableListProps<T>) {
  ...
  const [REORDER_SAVE] = useState<string>(LANG.REORDER_SAVE);
  const [REORDER_EDIT] = useState<string>(LANG.REORDER_EDIT);
  return (
    <Fragment>
      <div
        style={{
      ...
      >
        <Focusable
          ...
          onSecondaryActionDescription={reorderEnabled ? REORDER_SAVE : REORDER_EDIT}
